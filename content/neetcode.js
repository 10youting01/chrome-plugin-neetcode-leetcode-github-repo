  ...
  return new Promise((resolve) => {
    ...
    script.textContent = `
      (() => {
        ...
        const findCodeMirrorDoc = ${findCodeMirrorDoc.toString()};
        const findBestMonacoModel = ${findBestMonacoModel.toString()};
        const scoreMonacoModel = ${scoreMonacoModel.toString()};
        const looksLikeEditorCode = ${looksLikeEditorCode.toString()};
        const isSolutionLanguage = ${isSolutionLanguage.toString()};
        const isUrlLike = ${isUrlLike.toString()};
        try {
